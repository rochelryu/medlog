        ...
        function buildDropdown(originalDropdown) {
            ...
            var $dropdownBox =
                $('<div class="' + className + '-dropdown-box-wrapper dropdown-box-wrapper ' + id + '">\
                        <span class="' + className + '-dropdown-box-text dropdown-box-text">' + itemName + '</span>\
                    </div>');
            ...
            var $filterBox = $('<input type="text" placeholder="Quelle ' + itemName + '" class="' + className + '-filter-box filter-box"/>');
